...
def train(args, use_modal, local_rank):
    ...
    run_eval(model, item_word_embs, users_history_for_test, users_test, 512, item_num, use_modal,
                         args.mode, is_early_stop, local_rank)

def run_eval(model, item_word_embs, user_history, users_eval, batch_size, item_num, use_modal,
