...
def read_behaviors(behaviors_path, before_item_id_to_dic, before_item_name_to_id, min_seq_len, max_seq_len, Log_file):
    ...
    Log_file.info("##### max seq len {} #####".format(max_seq_len))
    ...
    for before_item_id in range(1, before_item_num + 1):
        if before_item_counts[before_item_id] != 0:
            ...
            item_id_to_content[item_id] = before_item_id_to_dic[before_item_id]
            item_id += 1
